        ...
        <div class="card border-0 shadow-lg overflow-hidden">
            <div class="row g-0">
                <div class="col-lg-6 position-relative cursor-pointer hover-zoom-container" data-bs-toggle="modal" data-bs-target="#modalFoto" onclick="showImage(this)">
                    ...
                    <img src="{{ asset ('img/lapbad.jpg') }}" onerror="this.src='https://via.placeholder.com/800x600?text=LAPANGAN+BADMINTON'" class="img-fluid h-100 w-100 zoom-effect" style="object-fit: cover; min-height: 400px;" alt="Lapangan Badminton">
                    ...
                    <div class="position-absolute top-0 start-0 m-3 z-2">
                        <span class="badge bg-warning text-dark fw-bold px-3 py-2 shadow">
                            <i class="fa-solid fa-table-tennis-paddle-ball me-2"></i>Olahraga
                        </span>
                    </div>
                </div>
                ...
                <div class="col-lg-6 p-5 d-flex flex-column justify-content-center bg-white">
                    <h2 class="fw-bold text-uppercase text-warning mb-2">
                        <i class="fa-solid fa-table-tennis-paddle-ball me-2"></i>Lapangan Badminton
                    </h2>
                    <p class="text-muted small mb-4">Area Olahraga Indoor/Outdoor</p>

                    <p class="lead text-dark mb-4">
                        Area olahraga bulu tangkis yang nyaman dengan lantai standar, mendukung aktivitas fisik dan kompetisi santri.
                    </p>
                    
                    <div class="mb-4">
                        <h6 class="fw-bold text-dark border-bottom pb-2 border-warning d-inline-block">Fasilitas Tersedia:</h6>
                        <ul class="list-unstyled mt-2 text-secondary">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-warning me-2"></i><strong>2 Line Lapangan:</strong> Standar pertandingan.</li>
                            <li class="mb-2"><i class="bi bi-lightbulb-fill text-warning me-2"></i><strong>Penerangan LED:</strong> Terang untuk main malam hari.</li>
                            <li><i class="bi bi-basket-fill text-warning me-2"></i><strong>Sewa Raket:</strong> Tersedia di Koperasi Santri.</li>
                        </ul>
                    </div>
                    ...
                    <div class="alert alert-warning border-0 bg-warning bg-opacity-10 text-dark small">
                        ...
                        Menjadi olahraga favorit santri untuk mengisi waktu luang di hari libur. Sering digunakan juga oleh para Asatidz untuk menjaga kebugaran rutin.
                    </div>
                </div>
            </div>
        </div>
